deps_config := \
	...
	drivers/uwb/Kconfig \
	drivers/input/sec_input/slsi/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.4.242"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/hasaja/android/toolchains/clang-10.0/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "ld.lld"
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=aarch64-linux-android- --gcc-toolchain=/ -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
...
ifneq "$(SEC_BUILD_CONF_VENDOR_BUILD_OS)" "14"
include/config/auto.conf: FORCE
endif
