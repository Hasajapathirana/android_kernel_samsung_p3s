cmd_usr/include/linux/ppp_defs.hdrtest := /home/hasaja/android/toolchains/clang-10.0/bin/clang -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MD,usr/include/linux/.ppp_defs.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/ppp_defs.h; perl ./scripts/headers_check.pl usr/include arm64 usr/include/linux/ppp_defs.h; touch usr/include/linux/ppp_defs.hdrtest
