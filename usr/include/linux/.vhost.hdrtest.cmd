cmd_usr/include/linux/vhost.hdrtest := /home/hasaja/android/toolchains/clang-10.0/bin/clang -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MD,usr/include/linux/.vhost.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/vhost.h; perl ./scripts/headers_check.pl usr/include arm64 usr/include/linux/vhost.h; touch usr/include/linux/vhost.hdrtest
